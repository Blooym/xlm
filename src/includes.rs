...
/// toolmanifest.vdf content as bytes.
pub const TOOLMANIFEST_VDF_CONTENT: &[u8] = include_bytes!("../static/toolmanifest.vdf");
/// compatibilitytool.vdf content as bytes.
pub const COMPATIBILITYTOOL_VDF_CONTENT: &[u8] = include_bytes!("../static/compatibilitytool.vdf");
/// embedded aria2c tarball as bytes.
pub static EMBEDDED_ARIA2C_TARBALL: &[u8] = include_bytes!("../static/aria2c-static.tar.gz");
